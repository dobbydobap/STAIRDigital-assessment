...
def main() -> int:
    ...
    for mod in ("fitz", "groq", "chromadb", "FlagEmbedding", "fastapi", "streamlit", "yaml", "pydantic"):
        try:
            __import__(mod)
    ...
    try:
        ...
        if not CONFIG.groq_api_key:
            failures.append(_fail("GROQ_API_KEY is empty (set it in .env — get one at https://console.groq.com/keys)"))
        else:
